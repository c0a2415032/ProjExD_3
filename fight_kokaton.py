...
class score:
    ...
    def __init__(self):
        ...
        """
        self.suko=0
        self.fonto = pg.font.SysFont("hgp創英角ﾎﾟｯﾌﾟ体", 30)#文字設定
        self.txt = self.fonto.render(f"スコア：{self.suko}",True, (0, 0, 255))#サーフェイス作成
        self.xy = 100,HEIGHT-50 #スコア表示座標
